...
export function InstallPwaPrompt() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 border-t border-line bg-card px-4 py-3 text-ink shadow-2xl shadow-black/40">
      <div className="mx-auto flex max-w-xl items-center gap-3">
        ...
        <button onClick={dismiss} aria-label="Dismiss" className="shrink-0 rounded-full p-2 text-ink-soft hover:text-ink">
